 ...
 * @author LEILA
 */
public class SWAFixedValues {
    public SWAFixedValues(String seq1, String seq2, String Gap, String match, String mismatch){
        ...
        SmithWaterman SM = new SmithWaterman(Integer.parseInt(match), Integer.parseInt(mismatch), Integer.parseInt(Gap), seq1, seq2);
